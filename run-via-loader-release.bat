...
cargo +nightly-2025-06-23-i686-pc-windows-msvc build --manifest-path openzt-dll/Cargo.toml --lib --release --target=i686-pc-windows-msvc %*
...
REM Building and running openzt loader
