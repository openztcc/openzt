...
mod bf_version_info {
    ...
    use openzt_detour::BFVERSIONINFO_GETVERSIONSTRING;

    #[detour(BFVERSIONINFO_GETVERSIONSTRING)]
    unsafe extern "cdecl" fn bf_version_info_get_version_string_hook(param_1: u32, param_2: u32, param_3: u32) -> u32 {
        let return_value = unsafe { BFVERSIONINFO_GETVERSIONSTRING_DETOUR.call(param_1, param_2, param_3) };
