...
pub mod bfaimgr {
    ...
    pub const LOAD_DATA: FunctionDef<unsafe extern "thiscall" fn(*const u32, bool) -> u32> = FunctionDef{address: 0x0058f269, function_type: PhantomData};
...
pub mod bfapp {
    ...
    pub const HANDLE_MESSAGES: FunctionDef<unsafe extern "stdcall" fn(u32, u32, u32, u32) -> u32> = FunctionDef{address: 0x00418f4f, function_type: PhantomData};
...
pub mod bfconfigfile {
    ...
    pub const GET_FLOAT_LIST: FunctionDef<unsafe extern "thiscall" fn(*const u32, *const i8, *const i8) -> *const u32> = FunctionDef{address: 0x00591a5a, function_type: PhantomData};
...
pub mod bfgameapp {
    ...
    pub const HANDLE_MESSAGES: FunctionDef<unsafe extern "stdcall" fn(u32, u32, u32, u32) -> u32> = FunctionDef{address: 0x00418f97, function_type: PhantomData};
...
pub mod bfuimgr {
    ...
    pub const HANDLE_MESSAGES: FunctionDef<unsafe extern "thiscall" fn(*const u32, u32, u32, u32, u32) -> i32> = FunctionDef{address: 0x00441d7b, function_type: PhantomData};
...
pub mod bfversioninfo {
    ...
    pub const GET_VERSION_STRING: FunctionDef<unsafe extern "cdecl" fn(u32, *const c_void, u32) -> u32> = FunctionDef{address: 0x004bdfd4, function_type: PhantomData};
...
pub mod gxcanvas {
    ...
    pub const STRING: FunctionDef<unsafe extern "thiscall" fn(*const u32, u32, *const u32, i32, i32) -> u32> = FunctionDef{address: 0x004b189d, function_type: PhantomData};
}
...
pub mod uicontrol {
    ...
    pub const SET_ICON_0: FunctionDef<unsafe extern "thiscall" fn(*const u32, *const u32, i32, i32)> = FunctionDef{address: 0x004ee2ba, function_type: PhantomData};
    pub const SET_ICON_1: FunctionDef<unsafe extern "thiscall" fn(*const u32, *const i8, i32, bool, i32, i32)> = FunctionDef{address: 0x004faa82, function_type: PhantomData};
...
pub mod uigraph {
    ...
    pub const ADD_POINT_0: FunctionDef<unsafe extern "thiscall" fn(*const u32, *const u32, i32, *const u32, u32, i32)> = FunctionDef{address: 0x00530614, function_type: PhantomData};
    pub const ADD_POINT_1: FunctionDef<unsafe extern "thiscall" fn(*const u32, *const u32, *const i16, *const u32)> = FunctionDef{address: 0x005307ec, function_type: PhantomData};
...
pub mod uilistboxitem {
    ...
    pub const RENDER_TEXT_ENTRIES: FunctionDef<unsafe extern "thiscall" fn(*const u32, u32, u32, i32, u32, i32, u32)> = FunctionDef{address: 0x004ecba7, function_type: PhantomData};
...
pub mod uistatusimage {
    ...
    pub const SET_TRANSITION_VALUES: FunctionDef<unsafe extern "cdecl" fn(bool, i32, u32)> = FunctionDef{address: 0x00467963, function_type: PhantomData};
...
pub mod ztanimal {
    ...
    pub const GET_HAPPY_PCT: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> i32> = FunctionDef{address: 0x00467366, function_type: PhantomData};
    pub const GET_HUNGER_PCT: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> i32> = FunctionDef{address: 0x004678bf, function_type: PhantomData};
...
pub mod ztawardmgr {
    ...
    pub const CONSTRUCTOR: FunctionDef<unsafe extern "fastcall" fn(u32)> = FunctionDef{address: 0x00571460, function_type: PhantomData};
    pub const ZTAWARD_MGR: FunctionDef<unsafe extern "stdcall" fn()> = FunctionDef{address: 0x0058686b, function_type: PhantomData};
...
pub mod ztgamemgr {
    ...
    pub const ANIMAL_TIME_AGO: FunctionDef<unsafe extern "thiscall" fn(*const u32, u32, i32) -> u64> = FunctionDef{address: 0x00467a14, function_type: PhantomData};
    ...
    pub const INIT_MENU_MUSIC: FunctionDef<unsafe extern "fastcall" fn(*const u32)> = FunctionDef{address: 0x00521e18, function_type: PhantomData};
    ...
    pub const OVERRIDE_NEW_GAME_DEFAULTS: FunctionDef<unsafe extern "thiscall" fn(*const u32, *const u32)> = FunctionDef{address: 0x00591a40, function_type: PhantomData};
...
pub mod ztgamemgr_menumusichandler {
    ...
    pub const UPDATE: FunctionDef<unsafe extern "thiscall" fn(*const u32, u32)> = FunctionDef{address: 0x0041a13a, function_type: PhantomData};
    pub const MENU_MUSIC_HANDLER_0: FunctionDef<unsafe extern "fastcall" fn(*const i32)> = FunctionDef{address: 0x00504e27, function_type: PhantomData};
    ...
    pub const START_FADE: FunctionDef<unsafe extern "fastcall" fn(*const u32)> = FunctionDef{address: 0x00592570, function_type: PhantomData};
}
...
pub mod ztgoalbagdoo {
    ...
    pub const REMOVE_ZOODOO: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> u32> = FunctionDef{address: 0x0050e392, function_type: PhantomData};
    pub const COMPLETE: FunctionDef<unsafe extern "thiscall" fn(*const u32)> = FunctionDef{address: 0x0050e3ef, function_type: PhantomData};
...
pub mod ztgoalhabitatduties {
    ...
    pub const NEED_SHOW: FunctionDef<unsafe extern "thiscall" fn(*const u32, *const u32)> = FunctionDef{address: 0x0049eed6, function_type: PhantomData};
...
pub mod ztguest {
    ...
    pub const GET_HAPPY_PCT: FunctionDef<unsafe extern "fastcall" fn(i32) -> i32> = FunctionDef{address: 0x0046a606, function_type: PhantomData};
    pub const GET_THIRST_PCT: FunctionDef<unsafe extern "fastcall" fn(i32) -> i32> = FunctionDef{address: 0x0046a655, function_type: PhantomData};
    pub const GET_HUNGER_PCT: FunctionDef<unsafe extern "fastcall" fn(i32) -> i32> = FunctionDef{address: 0x0046a6a4, function_type: PhantomData};
    pub const GET_ENERGY_PCT: FunctionDef<unsafe extern "fastcall" fn(i32) -> i32> = FunctionDef{address: 0x0046a6f3, function_type: PhantomData};
    pub const GET_BATHROOM_PCT: FunctionDef<unsafe extern "fastcall" fn(i32) -> i32> = FunctionDef{address: 0x0046a742, function_type: PhantomData};
    ...
    pub const VF_RETURN0: FunctionDef<unsafe extern "thiscall" fn(*const u32, u32, bool) -> u8> = FunctionDef{address: 0x00613156, function_type: PhantomData};
...
pub mod zthabitat {
    ...
    pub const CONSTRUCT_SURROUNDING_SPECIES_LIST: FunctionDef<unsafe extern "fastcall" fn(*const i32)> = FunctionDef{address: 0x00446265, function_type: PhantomData};
...
pub mod zthabitatmgr {
    ...
    pub const GET_NUM_SPECIES: FunctionDef<unsafe extern "fastcall" fn(*const u32) -> i32> = FunctionDef{address: 0x0041f0a6, function_type: PhantomData};
    ...
    pub const GET_NUM_FAMILIES: FunctionDef<unsafe extern "fastcall" fn(i32) -> i32> = FunctionDef{address: 0x006049b5, function_type: PhantomData};
    pub const GET_AVERAGE_HABITAT_ATTRACTIVENESS: FunctionDef<unsafe extern "fastcall" fn(i32) -> i32> = FunctionDef{address: 0x00604aae, function_type: PhantomData};
}
...
pub mod ztmapview {
    ...
    pub const CHECK_TANK_PLACEMENT: FunctionDef<unsafe extern "stdcall" fn(*const u32, *const u32, *const u32) -> bool> = FunctionDef{address: 0x004df688, function_type: PhantomData};
    ...
    pub const REMOVE_ENTITY_FROM_MAP: FunctionDef<unsafe extern "thiscall" fn(*const u32, *const i32, f32, i8, *const i32, i8)> = FunctionDef{address: 0x0050a0b0, function_type: PhantomData};
    ...
    pub const SET_MOUSE_SCROLL_DXDY: FunctionDef<unsafe extern "thiscall" fn(*const u32, i32)> = FunctionDef{address: 0x0051a33c, function_type: PhantomData};
...
pub mod ztscenariosimplegoal {
    ...
    pub const EVAL03: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> i32> = FunctionDef{address: 0x0041dcfa, function_type: PhantomData};
...
pub mod ztshow {
    ...
    pub const CHECK_SCRIPT: FunctionDef<unsafe extern "thiscall" fn(*const u32, u16) -> u32> = FunctionDef{address: 0x0059e2bd, function_type: PhantomData};
    ...
    pub const GET_SHOW_SCRIPT_STATE: FunctionDef<unsafe extern "thiscall" fn(*const u32, u32) -> u32> = FunctionDef{address: 0x0059eb99, function_type: PhantomData};
    pub const ABOUT_TO_START: FunctionDef<unsafe extern "thiscall" fn(*const u32, *const bool) -> u32> = FunctionDef{address: 0x0059ec16, function_type: PhantomData};
    ...
    pub const RUN: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> i32> = FunctionDef{address: 0x005a21c5, function_type: PhantomData};
    ...
    pub const DO_KEEPER_EVENT: FunctionDef<unsafe extern "thiscall" fn(*const u32, u16, *const u32)> = FunctionDef{address: 0x005a6730, function_type: PhantomData};
    pub const DO_TRICK_EVENT: FunctionDef<unsafe extern "thiscall" fn(*const u32, *const u32)> = FunctionDef{address: 0x005a6894, function_type: PhantomData};
    pub const VALIDATE_ITEM: FunctionDef<unsafe extern "thiscall" fn(*const u32, u16) -> u32> = FunctionDef{address: 0x005a6d70, function_type: PhantomData};
    pub const SEND_EVENT_TO_UNIT: FunctionDef<unsafe extern "thiscall" fn(*const u32, u16, u32)> = FunctionDef{address: 0x005a6e46, function_type: PhantomData};
    ...
    pub const CALCULATE_PERCENT_ADJUSTMENT: FunctionDef<unsafe extern "fastcall" fn(*const u32) -> i32> = FunctionDef{address: 0x005a898f, function_type: PhantomData};
    pub const CALCULATE_REST_BONUS: FunctionDef<unsafe extern "fastcall" fn(*const u32) -> i32> = FunctionDef{address: 0x005a89d9, function_type: PhantomData};
    pub const SEND_SHOW_ENDED_EVENT: FunctionDef<unsafe extern "thiscall" fn(*const u32)> = FunctionDef{address: 0x005a89f4, function_type: PhantomData};
    pub const CALCULATE_SATISFACTION_PERCENT: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> u32> = FunctionDef{address: 0x005a8a1d, function_type: PhantomData};
    ...
    pub const ABORT_CURRENT_ITEM: FunctionDef<unsafe extern "thiscall" fn(*const u32, u32, u32) -> u32> = FunctionDef{address: 0x00612d38, function_type: PhantomData};
}
...
pub mod ztshowinfo {
    ...
    pub const VALIDATE_TRICK: FunctionDef<unsafe extern "thiscall" fn(*const u32, *const u32) -> u32> = FunctionDef{address: 0x0046e5bc, function_type: PhantomData};
    pub const ADD_SCRIPT: FunctionDef<unsafe extern "thiscall" fn(*const u32, u32, u16) -> bool> = FunctionDef{address: 0x0046e8b5, function_type: PhantomData};
    pub const CREATE_DEFAULT_SCRIPT: FunctionDef<unsafe extern "thiscall" fn(*const u32, i32) -> *const u32> = FunctionDef{address: 0x0046eeed, function_type: PhantomData};
    ...
    pub const CHECK_UNIT_TYPE: FunctionDef<unsafe extern "thiscall" fn(*const u32, u32) -> u32> = FunctionDef{address: 0x005a41e4, function_type: PhantomData};
    pub const CHECK_UNIT: FunctionDef<unsafe extern "thiscall" fn(*const u32, u32) -> u32> = FunctionDef{address: 0x005a4215, function_type: PhantomData};
    pub const GATHER_UNITS: FunctionDef<unsafe extern "thiscall" fn(*const u32, u32) -> u32> = FunctionDef{address: 0x005a437d, function_type: PhantomData};
...
pub mod ztshowmgr {
    ...
    pub const REGISTER_SCRIPT: FunctionDef<unsafe extern "thiscall" fn(*const u32, *const u32) -> u32> = FunctionDef{address: 0x0046e89c, function_type: PhantomData};
    pub const UNREGISTER_SCRIPT: FunctionDef<unsafe extern "thiscall" fn(*const u32, *const u32) -> u32> = FunctionDef{address: 0x00473120, function_type: PhantomData};
    pub const GET_SHOW_SCRIPT_ITEMS: FunctionDef<unsafe extern "thiscall" fn(*const u32, u32, u8)> = FunctionDef{address: 0x004755d1, function_type: PhantomData};
    ...
    pub const IS_DOING_SHOW: FunctionDef<unsafe extern "thiscall" fn(*const u32, u32, u16) -> u32> = FunctionDef{address: 0x0059eb6e, function_type: PhantomData};
    pub const IS_SHOW_SCRIPT_DONE: FunctionDef<unsafe extern "thiscall" fn(*const u32, u32, u16) -> u32> = FunctionDef{address: 0x0059fab2, function_type: PhantomData};
    ...
    pub const GET_SCRIPT_ID: FunctionDef<unsafe extern "thiscall" fn(*const u32, u16) -> u32> = FunctionDef{address: 0x005a2665, function_type: PhantomData};
...
pub mod ztshowscript {
    ...
    pub const ADD_ITEM: FunctionDef<unsafe extern "thiscall" fn(*const u32, [u8; 0x7c]) -> u32> = FunctionDef{address: 0x0046cdd4, function_type: PhantomData};
    pub const LOAD: FunctionDef<unsafe extern "thiscall" fn(*const u32, *const u32, u32) -> u32> = FunctionDef{address: 0x0046cf97, function_type: PhantomData};
    pub const ZTSHOW_SCRIPT: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> *const u32> = FunctionDef{address: 0x00472f62, function_type: PhantomData};
    pub const CLEAR_ALL: FunctionDef<unsafe extern "thiscall" fn(*const u32)> = FunctionDef{address: 0x00475c0f, function_type: PhantomData};
    pub const SIZE: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> i32> = FunctionDef{address: 0x0059e275, function_type: PhantomData};
    ...
    pub const GET_ITEM: FunctionDef<unsafe extern "thiscall" fn(*const u32, u16) -> u32> = FunctionDef{address: 0x005a2555, function_type: PhantomData};
    pub const GET_ITEM_BY_TRICK_ID: FunctionDef<unsafe extern "thiscall" fn(*const u32, u16) -> u32> = FunctionDef{address: 0x005a25eb, function_type: PhantomData};
    ...
    pub const REMOVE_ITEM: FunctionDef<unsafe extern "thiscall" fn(*const u32, u16) -> u32> = FunctionDef{address: 0x0061c8f0, function_type: PhantomData};
}
...
pub mod ztshowscriptitem {
    ...
    pub const LOAD_0: FunctionDef<unsafe extern "thiscall" fn(*const u32, *const u32, u32) -> u32> = FunctionDef{address: 0x0046d2d7, function_type: PhantomData};
    pub const CONSTRUCTOR_0: FunctionDef<unsafe extern "thiscall" fn(*const u32, u32) -> *const u32> = FunctionDef{address: 0x004b9024, function_type: PhantomData};
    pub const CONSTRUCTOR_1: FunctionDef<unsafe extern "thiscall" fn(*const u32, u32) -> *const u32> = FunctionDef{address: 0x004b91d6, function_type: PhantomData};
    pub const LOAD_1: FunctionDef<unsafe extern "thiscall" fn(*const u32, *const u32, *const i8) -> u32> = FunctionDef{address: 0x004b9690, function_type: PhantomData};
    pub const INIT: FunctionDef<unsafe extern "thiscall" fn(*const u32)> = FunctionDef{address: 0x0061c43a, function_type: PhantomData};
    pub const SAVE: FunctionDef<unsafe extern "thiscall" fn(*const u32, *const i8) -> bool> = FunctionDef{address: 0x0061c471, function_type: PhantomData};
}
...
pub mod ztshowscriptmgr {
    ...
    pub const UNREGISTER_SCRIPT: FunctionDef<unsafe extern "thiscall" fn(*const u32, *const u32) -> u32> = FunctionDef{address: 0x00472fb8, function_type: PhantomData};
    pub const GET_SHOW_SCRIPT_ITEMS: FunctionDef<unsafe extern "stdcall" fn(*const u32, u32)> = FunctionDef{address: 0x00475505, function_type: PhantomData};
    ...
    pub const CLEAR_ALL_SCRIPTS: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> u32> = FunctionDef{address: 0x004c6e1f, function_type: PhantomData};
    ...
    pub const ZTSHOW_SCRIPT_MGR: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> *const u32> = FunctionDef{address: 0x0057dd6c, function_type: PhantomData};
    pub const GET_SCRIPT: FunctionDef<unsafe extern "thiscall" fn(*const u32, u16) -> u32> = FunctionDef{address: 0x0059e216, function_type: PhantomData};
}
...
pub mod ztshowscriptstate {
    ...
    pub const SET_NEXT_ITEM_0: FunctionDef<unsafe extern "thiscall" fn(*const u32, u16) -> u32> = FunctionDef{address: 0x005a6778, function_type: PhantomData};
    pub const SET_NEXT_ITEM_1: FunctionDef<unsafe extern "thiscall" fn(*const u32)> = FunctionDef{address: 0x005a67d0, function_type: PhantomData};
...
pub mod zttankfilter {
    ...
    pub const VERIFY_BUBBLES_POSITION: FunctionDef<unsafe extern "thiscall" fn(*const u32)> = FunctionDef{address: 0x0049bbe7, function_type: PhantomData};
    pub const FILTER: FunctionDef<unsafe extern "thiscall" fn(*const u32)> = FunctionDef{address: 0x0049be17, function_type: PhantomData};
    pub const CHARGE_UPKEEP: FunctionDef<unsafe extern "thiscall" fn(*const u32)> = FunctionDef{address: 0x0049bec7, function_type: PhantomData};
    pub const ADD_BUBBLES: FunctionDef<unsafe extern "thiscall" fn(*const u32)> = FunctionDef{address: 0x0049bf25, function_type: PhantomData};
...
pub mod ztui_showpanel {
    ...
    pub const RECALC_SHOW_STATS: FunctionDef<unsafe extern "cdecl" fn(*const u32)> = FunctionDef{address: 0x00474826, function_type: PhantomData};
    ...
    pub const ADD_CALLBACKS: FunctionDef<unsafe extern "stdcall" fn()> = FunctionDef{address: 0x0051712a, function_type: PhantomData};
    pub const UPDATE_SHOW_TRICK_LIST: FunctionDef<unsafe extern "stdcall" fn()> = FunctionDef{address: 0x0059c2c4, function_type: PhantomData};
...
pub mod ztunit {
    ...
    pub const GET_SHOW_ITEM: FunctionDef<unsafe extern "thiscall" fn(*const u32, u16, u16)> = FunctionDef{address: 0x005a2682, function_type: PhantomData};
    pub const HAS_SHOW_KEEPER: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> u32> = FunctionDef{address: 0x005a6f50, function_type: PhantomData};
...
pub mod ztunittype {
    ...
    pub const GET_SHOW_ITEM: FunctionDef<unsafe extern "stdcall" fn(u16, u32) -> u32> = FunctionDef{address: 0x005a263a, function_type: PhantomData};
...
pub mod ztworldmgr {
    ...
    pub const PLAY_SHOW_SOUND: FunctionDef<unsafe extern "stdcall" fn(u32, u16, *const i32)> = FunctionDef{address: 0x005a28fb, function_type: PhantomData};
...
pub mod zoostatus {
    ...
    pub const GET_STATUS: FunctionDef<unsafe extern "thiscall" fn(*const u32, i32, i32, i32) -> *const f32> = FunctionDef{address: 0x0041dd64, function_type: PhantomData};
    ...
    pub const HEAL_ANIMAL: FunctionDef<unsafe extern "thiscall" fn(*const u32, f32)> = FunctionDef{address: 0x0047039e, function_type: PhantomData};
    ...
    pub const PURCHASE_FOOD: FunctionDef<unsafe extern "thiscall" fn(*const u32, f32)> = FunctionDef{address: 0x0048f7e9, function_type: PhantomData};
    ...
    pub const OVERRIDE: FunctionDef<unsafe extern "thiscall" fn(*const u32, *const u32)> = FunctionDef{address: 0x004bbef5, function_type: PhantomData};
    pub const SET_ADULT_ADMISSION_PRICE: FunctionDef<unsafe extern "thiscall" fn(*const u32, f32)> = FunctionDef{address: 0x004bbf10, function_type: PhantomData};
    ...
    pub const BUY_ANIMAL: FunctionDef<unsafe extern "thiscall" fn(*const u32, f32)> = FunctionDef{address: 0x004e1fde, function_type: PhantomData};
    ...
    pub const INCREASE_ADMISSIONS_INCOME: FunctionDef<unsafe extern "thiscall" fn(*const u32, f32)> = FunctionDef{address: 0x004f7da4, function_type: PhantomData};
    pub const INCREASE_ADMISSIONS: FunctionDef<unsafe extern "thiscall" fn(*const u32, i32)> = FunctionDef{address: 0x004f7e2f, function_type: PhantomData};
    ...
    pub const SHOW_PRICES: FunctionDef<unsafe extern "thiscall" fn(*const u32)> = FunctionDef{address: 0x00530329, function_type: PhantomData};
    ...
    pub const SPEND_KEEPER_WAGES: FunctionDef<unsafe extern "thiscall" fn(*const u32, f32)> = FunctionDef{address: 0x005ad038, function_type: PhantomData};
...
pub mod bfinternat {
    ...
    pub const GET_TEXT_RESOURCE: FunctionDef<unsafe extern "cdecl" fn(*const u32, u32) -> *const u32> = FunctionDef{address: 0x004f00f6, function_type: PhantomData};
    ...
    pub const GET_MONTH_ABBREVIATION: FunctionDef<unsafe extern "cdecl" fn(*const u32, i32) -> *const u32> = FunctionDef{address: 0x0052f74b, function_type: PhantomData};
...
// msvc_std::__vector_deleter<> class functions
pub mod msvc_std_vector_deleter {
    use super::*;
...
// msvc_std::basic_string<> class functions
pub mod msvc_std_basic_string {
    use super::*;
...
pub mod standalone {
    ...
    pub const VER_QUERY_VALUE_A: FunctionDef<unsafe extern "stdcall" fn(u32, u32, *const c_void, u32) -> bool> = FunctionDef{address: 0x0040dcfb, function_type: PhantomData};
    ...
    pub const SHOW_KEEPER_INFO: FunctionDef<unsafe extern "thiscall" fn(*const c_void, i32) -> u32> = FunctionDef{address: 0x0041680c, function_type: PhantomData};
    ...
    pub const UIRENDER_TEXT_0: FunctionDef<unsafe extern "cdecl" fn(u32, *const u8, i32, i32, i32, u32, i32, u32, u32, u32, u32, i8, i32)> = FunctionDef{address: 0x00419b0c, function_type: PhantomData};
    ...
    pub const UPDATE_INFO_0: FunctionDef<unsafe extern "cdecl" fn(*const u32)> = FunctionDef{address: 0x004673b5, function_type: PhantomData};
    ...
    pub const UPDATE_INFO_1: FunctionDef<unsafe extern "cdecl" fn(*const u32)> = FunctionDef{address: 0x0046a144, function_type: PhantomData};
    pub const SHOW_GUEST_INFO: FunctionDef<unsafe extern "stdcall" fn()> = FunctionDef{address: 0x0046a91b, function_type: PhantomData};
    ...
    pub const UPDATE_INFO_2: FunctionDef<unsafe extern "cdecl" fn(*const i32)> = FunctionDef{address: 0x0047108a, function_type: PhantomData};
    pub const ADD_SPECIES_FROM_HABITAT: FunctionDef<unsafe extern "cdecl" fn(*const u32, *const u32, *const i32)> = FunctionDef{address: 0x0047375c, function_type: PhantomData};
    pub const COLLECT_ANIMAL_TYPES: FunctionDef<unsafe extern "stdcall" fn() -> *const i32> = FunctionDef{address: 0x00473978, function_type: PhantomData};
    ...
    pub const WRITE_BYTES_TO_FILE: FunctionDef<unsafe extern "cdecl" fn(*const u32, u32, u32, *const i8) -> i32> = FunctionDef{address: 0x0047772e, function_type: PhantomData};
    pub const PLAY_SHOW_END_SOUND: FunctionDef<unsafe extern "cdecl" fn(*const u32, u16, i32, u32)> = FunctionDef{address: 0x0047b0d4, function_type: PhantomData};
    ...
    pub const UPDATE_INFO_3: FunctionDef<unsafe extern "stdcall" fn()> = FunctionDef{address: 0x004834cc, function_type: PhantomData};
    pub const UPDATE_INFO_4: FunctionDef<unsafe extern "stdcall" fn()> = FunctionDef{address: 0x00483724, function_type: PhantomData};
    ...
    pub const UPDATE_INFO_5: FunctionDef<unsafe extern "cdecl" fn(i32)> = FunctionDef{address: 0x00488446, function_type: PhantomData};
    ...
    pub const UPDATE_INFO_6: FunctionDef<unsafe extern "cdecl" fn()> = FunctionDef{address: 0x004a02f7, function_type: PhantomData};
    ...
    pub const GET_OLD_DATE: FunctionDef<unsafe extern "stdcall" fn() -> i64> = FunctionDef{address: 0x004c2bb9, function_type: PhantomData};
    ...
    pub const UPDATE_INFO_7: FunctionDef<unsafe extern "cdecl" fn()> = FunctionDef{address: 0x004eae69, function_type: PhantomData};
    ...
    pub const ADJUST_TOOLTIP_DURATION: FunctionDef<unsafe extern "cdecl" fn(i32)> = FunctionDef{address: 0x0051a59f, function_type: PhantomData};
    ...
    pub const UPDATE_RATINGS_GRAPH: FunctionDef<unsafe extern "cdecl" fn(*const c_void)> = FunctionDef{address: 0x0052feef, function_type: PhantomData};
    ...
    pub const UPDATE_DONATIONS_GRAPH: FunctionDef<unsafe extern "cdecl" fn(*const c_void)> = FunctionDef{address: 0x00530a0e, function_type: PhantomData};
    pub const UPDATE_PROFIT_GRAPH: FunctionDef<unsafe extern "cdecl" fn(*const c_void)> = FunctionDef{address: 0x00530aff, function_type: PhantomData};
    pub const UPDATE_ATTENDANCE_GRAPH: FunctionDef<unsafe extern "cdecl" fn(*const c_void)> = FunctionDef{address: 0x00530bf2, function_type: PhantomData};
    ...
    pub const GET_FILE_VERSION_INFO_SIZE_A: FunctionDef<unsafe extern "stdcall" fn(u32, u32) -> u32> = FunctionDef{address: 0x005357d6, function_type: PhantomData};
    pub const GET_FILE_VERSION_INFO_A: FunctionDef<unsafe extern "stdcall" fn(u32, u32, u32, u32) -> bool> = FunctionDef{address: 0x005357dc, function_type: PhantomData};
    ...
    pub const INIT_SHOW_SCRIPT_STATE: FunctionDef<unsafe extern "stdcall" fn() -> i32> = FunctionDef{address: 0x005a3de4, function_type: PhantomData};
    ...
    pub const PLAY_TRICK_SOUND: FunctionDef<unsafe extern "cdecl" fn(*const u32, u16, i32)> = FunctionDef{address: 0x005a7601, function_type: PhantomData};
    ...
    pub const UPDATE_INFO_8: FunctionDef<unsafe extern "stdcall" fn()> = FunctionDef{address: 0x005b108b, function_type: PhantomData};
    ...
    pub const IMM_NOTIFY_IME: FunctionDef<unsafe extern "stdcall" fn(u32, u32, u32, u32) -> bool> = FunctionDef{address: 0x0062c7d3, function_type: PhantomData};
