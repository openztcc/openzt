...
pub mod bfaimgr {
    ...
    pub const BFAIMGR: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> *const u32> = FunctionDef{address: 0x0050374b, function_type: PhantomData};
    ...
    pub const GET_PATH: FunctionDef<unsafe extern "thiscall" fn(*const u32)> = FunctionDef{address: 0x0052d8e8, function_type: PhantomData};
...
pub mod bfapp {
    ...
    pub const INIT_INSTANCE: FunctionDef<unsafe extern "thiscall" fn(*const u32, i32, i32, i32) -> bool> = FunctionDef{address: 0x005340ba, function_type: PhantomData};
    ...
    pub const INIT_WINDOW_CLASS: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> bool> = FunctionDef{address: 0x005376bb, function_type: PhantomData};
...
pub mod bfentity {
    ...
    pub const INIT_AMBIENT_ANIMS: FunctionDef<unsafe extern "thiscall" fn(*const u32)> = FunctionDef{address: 0x00401115, function_type: PhantomData};
    ...
    pub const DIR_TO_SET: FunctionDef<unsafe extern "thiscall" fn(*const u32, i32, *const u8, i32, *const i32) -> u32> = FunctionDef{address: 0x0040ff43, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("bfentity/validate_position"))]
    pub const VALIDATE_POSITION: FunctionDef<unsafe extern "thiscall" fn(*const u32, i8)> = FunctionDef{address: 0x0040ffc2, function_type: PhantomData};
    ...
    pub const SET_DRAW_DITHERED: FunctionDef<unsafe extern "thiscall" fn(*const u32)> = FunctionDef{address: 0x0041028c, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("bfentity/init_after_load"))]
    pub const INIT_AFTER_LOAD: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> u8> = FunctionDef{address: 0x00410cb0, function_type: PhantomData};
    ...
    pub const INIT: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> i32> = FunctionDef{address: 0x0041281b, function_type: PhantomData};
    ...
    pub const IS_WALKABLE_BY: FunctionDef<unsafe extern "thiscall" fn(*const u32, u32)> = FunctionDef{address: 0x004147fd, function_type: PhantomData};
    ...
    pub const SET_IS_REMOVED: FunctionDef<unsafe extern "thiscall" fn(*const u32)> = FunctionDef{address: 0x0041e0d9, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("bfentity/set_visible"))]
    pub const SET_VISIBLE: FunctionDef<unsafe extern "thiscall" fn(*const u32, u8)> = FunctionDef{address: 0x0041e0f0, function_type: PhantomData};
    ...
    pub const REPLACE_COLORS: FunctionDef<unsafe extern "thiscall" fn(*const u32, *const i32)> = FunctionDef{address: 0x00432fc7, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("bfentity/draw_0"))]
    pub const DRAW_0: FunctionDef<unsafe extern "thiscall" fn(*const u32, *const i32, i32, i32, i32, *const u8)> = FunctionDef{address: 0x00432ff4, function_type: PhantomData};
    ...
    pub const UPDATE_ANIMATION: FunctionDef<unsafe extern "thiscall" fn(*const u32, i32)> = FunctionDef{address: 0x00434899, function_type: PhantomData};
    ...
    pub const UPDATE: FunctionDef<unsafe extern "thiscall" fn(*const u32, i32)> = FunctionDef{address: 0x0043494e, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("bfentity/set_stop_at_end"))]
    pub const SET_STOP_AT_END: FunctionDef<unsafe extern "thiscall" fn(*const u32)> = FunctionDef{address: 0x00434aca, function_type: PhantomData};
    ...
    pub const DRAW_SHADOW: FunctionDef<unsafe extern "thiscall" fn(*const u32)> = FunctionDef{address: 0x0043f81c, function_type: PhantomData};
    ...
    pub const VERIFY_SHAPE: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> u8> = FunctionDef{address: 0x00446995, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("bfentity/set_name"))]
    pub const SET_NAME: FunctionDef<unsafe extern "thiscall" fn(*const u32)> = FunctionDef{address: 0x00449215, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("bfentity/load"))]
    pub const LOAD: FunctionDef<unsafe extern "thiscall" fn(*const u32, *const u8, u32) -> u32> = FunctionDef{address: 0x0044f866, function_type: PhantomData};
    ...
    pub const FORCE_ANIM: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> u32> = FunctionDef{address: 0x00485580, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("bfentity/morph"))]
    pub const MORPH: FunctionDef<unsafe extern "thiscall" fn(*const u32, *const i32, i8)> = FunctionDef{address: 0x004865c4, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("bfentity/calc_shadow_world_position"))]
    pub const CALC_SHADOW_WORLD_POSITION: FunctionDef<unsafe extern "thiscall" fn(*const u32)> = FunctionDef{address: 0x00492def, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("bfentity/draw_underwater_section"))]
    pub const DRAW_UNDERWATER_SECTION: FunctionDef<unsafe extern "thiscall" fn(*const u32, *const i32, u32, u32, i32, *const u8)> = FunctionDef{address: 0x00496b99, function_type: PhantomData};
    ...
    pub const DRAW_SELECTION_GRAPHIC: FunctionDef<unsafe extern "thiscall" fn(*const u32, i32, i32, *const i32)> = FunctionDef{address: 0x004ed85d, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("bfentity/set_selected"))]
    pub const SET_SELECTED: FunctionDef<unsafe extern "thiscall" fn(*const u32)> = FunctionDef{address: 0x004ee29a, function_type: PhantomData};
    ...
    pub const GET_DEPTH: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> u32> = FunctionDef{address: 0x005af392, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("bfentity/get_idle_anim"))]
    pub const GET_IDLE_ANIM: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> u32> = FunctionDef{address: 0x005ff91c, function_type: PhantomData};
    ...
    pub const DRAW_1: FunctionDef<unsafe extern "thiscall" fn(*const u32)> = FunctionDef{address: 0x005ff95b, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("bfentity/draw_aiinfo"))]
    pub const DRAW_AIINFO: FunctionDef<unsafe extern "thiscall" fn(*const u32)> = FunctionDef{address: 0x005ff9e8, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("bfentity/remove_from_map"))]
    pub const REMOVE_FROM_MAP: FunctionDef<unsafe extern "thiscall" fn(*const u32)> = FunctionDef{address: 0x005ff9eb, function_type: PhantomData};
...
pub mod bfentitytype {
    ...
    pub const LOAD_CHARACTERISTICS_0: FunctionDef<unsafe extern "thiscall" fn(*const u32, *const i8) -> *const i16> = FunctionDef{address: 0x004b4903, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("bfentitytype/load_characteristics_1"))]
    pub const LOAD_CHARACTERISTICS_1: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> u32> = FunctionDef{address: 0x004b4c2a, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("bfentitytype/load_color_rep_info"))]
    pub const LOAD_COLOR_REP_INFO: FunctionDef<unsafe extern "thiscall" fn(*const u32, *const i32, *const c_void) -> u32> = FunctionDef{address: 0x004bb159, function_type: PhantomData};
    ...
    pub const BFENTITY_TYPE: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> *const u32> = FunctionDef{address: 0x00500783, function_type: PhantomData};
...
pub mod bfgameapp {
    ...
    pub const RESTART_GRAPHICS_MGR: FunctionDef<unsafe extern "thiscall" fn(*const u32, i8) -> u32> = FunctionDef{address: 0x004ca9a4, function_type: PhantomData};
    ...
    pub const RESIZE_APP: FunctionDef<unsafe extern "thiscall" fn(*const u32, *const c_void, i32) -> u32> = FunctionDef{address: 0x004d6ce5, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("bfgameapp/init_instance_0"))]
    pub const INIT_INSTANCE_0: FunctionDef<unsafe extern "thiscall" fn(*const u32, i32, i32, i32, i8) -> u32> = FunctionDef{address: 0x00533552, function_type: PhantomData};
    ...
    pub const GET_SOUND: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> *const u32> = FunctionDef{address: 0x0057d5e1, function_type: PhantomData};
...
pub mod bfgamemgr {
    ...
    #[cfg_attr(feature = "detour-validation", validate_detour("bfgamemgr/bfgame_mgr"))]
    pub const BFGAME_MGR: FunctionDef<unsafe extern "thiscall" fn(*const u32, u8) -> *const u32> = FunctionDef{address: 0x0057d7f5, function_type: PhantomData};
    ...
    pub const LOAD: FunctionDef<unsafe extern "thiscall" fn(*const u32, *const u8, u32) -> bool> = FunctionDef{address: 0x00594cba, function_type: PhantomData};
}
...
pub mod bfgoal {
    ...
    pub const BFGOAL: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> *const u32> = FunctionDef{address: 0x004a4da2, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("bfgoal/constructor"))]
    pub const CONSTRUCTOR: FunctionDef<unsafe extern "thiscall" fn(*const u32, i32, u32) -> *const u32> = FunctionDef{address: 0x004a4e37, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("bfgoal/set_goal_target_pos"))]
    pub const SET_GOAL_TARGET_POS: FunctionDef<unsafe extern "thiscall" fn(*const u32)> = FunctionDef{address: 0x004a722c, function_type: PhantomData};
}
...
pub mod bfgoalfactory {
    ...
    pub const CREATE_0: FunctionDef<unsafe extern "thiscall" fn(*const u32, u32, u32) -> *const u32> = FunctionDef{address: 0x00413acd, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("bfgoalfactory/create_1"))]
    pub const CREATE_1: FunctionDef<unsafe extern "thiscall" fn(*const u32, i32, u32) -> *const u32> = FunctionDef{address: 0x00413ba8, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("bfgoalfactory/constructor_0"))]
    pub const CONSTRUCTOR_0: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> *const u32> = FunctionDef{address: 0x00502904, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("bfgoalfactory/bfgoal_factory"))]
    pub const BFGOAL_FACTORY: FunctionDef<unsafe extern "thiscall" fn(*const u32, u8)> = FunctionDef{address: 0x0050290b, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("bfgoalfactory/constructor_1"))]
    pub const CONSTRUCTOR_1: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> *const u32> = FunctionDef{address: 0x00502915, function_type: PhantomData};
}
...
pub mod bfmap {
    ...
    pub const GET_NEAREST_DIRECTION_0: FunctionDef<unsafe extern "fastcall" fn(u32, u32, i32, i32) -> u64> = FunctionDef{address: 0x00426c39, function_type: PhantomData};
    ...
    pub const GET_NEAREST_DIRECTION_1: FunctionDef<unsafe extern "fastcall" fn(u32, u32, *const i32) -> u64> = FunctionDef{address: 0x00440b46, function_type: PhantomData};
...
pub mod bfoldsubgoal {
    ...
    pub const UNKNOWN_METHOD: FunctionDef<unsafe extern "thiscall" fn(*const c_void, i32, u32) -> *const u32> = FunctionDef{address: 0x00413a43, function_type: PhantomData};
}
...
pub mod bfoverlay {
    ...
    pub const REMOVE_FROM_MAP: FunctionDef<unsafe extern "thiscall" fn(*const u32)> = FunctionDef{address: 0x00420565, function_type: PhantomData};
    ...
    pub const LOAD: FunctionDef<unsafe extern "thiscall" fn(*const u32, *const u8, u32) -> u32> = FunctionDef{address: 0x0045024d, function_type: PhantomData};
...
pub mod bfoverlaytype {
    ...
    pub const BFOVERLAY_TYPE: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> *const u32> = FunctionDef{address: 0x0057cc7a, function_type: PhantomData};
...
pub mod bfpathfinder {
    ...
    pub const VALIDATE: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> u32> = FunctionDef{address: 0x00414fef, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("bfpathfinder/estimate"))]
    pub const ESTIMATE: FunctionDef<unsafe extern "thiscall" fn(*const u32, *const f32, *const i32, *const i32) -> f32> = FunctionDef{address: 0x00415247, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("bfpathfinder/cost"))]
    pub const COST: FunctionDef<unsafe extern "thiscall" fn(*const u32, *const f32, i32, *const i32, *const c_void) -> f32> = FunctionDef{address: 0x004153e3, function_type: PhantomData};
...
pub mod bfresourcedir {
    ...
    pub const LOAD: FunctionDef<unsafe extern "thiscall" fn(*const u32, *const u32, u32, u32) -> u32> = FunctionDef{address: 0x00403b82, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("bfresourcedir/prepare"))]
    pub const PREPARE: FunctionDef<unsafe extern "thiscall" fn(*const u32, i32, u32, i8) -> u32> = FunctionDef{address: 0x00404926, function_type: PhantomData};
    ...
    pub const FIND_1: FunctionDef<unsafe extern "thiscall" fn(*const u32, *const i32, *const u8) -> *const i32> = FunctionDef{address: 0x004bfc2f, function_type: PhantomData};
    ...
    pub const INDEX: FunctionDef<unsafe extern "thiscall" fn(*const u32, u32) -> *const u32> = FunctionDef{address: 0x006030a4, function_type: PhantomData};
}
...
pub mod bfresourcezip {
    ...
    pub const PREPARE: FunctionDef<unsafe extern "thiscall" fn(*const u32, i32, u32, i8) -> u32> = FunctionDef{address: 0x004048da, function_type: PhantomData};
    ...
    pub const FIND_1: FunctionDef<unsafe extern "thiscall" fn(*const u32, *const i32, *const i8) -> *const i32> = FunctionDef{address: 0x004bf9fb, function_type: PhantomData};
    ...
    pub const INDEX: FunctionDef<unsafe extern "thiscall" fn(*const u32, *const i32) -> *const i32> = FunctionDef{address: 0x00602f65, function_type: PhantomData};
}
...
pub mod bfscenariomgr {
    ...
    pub const BFSCENARIO_MGR: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> *const u32> = FunctionDef{address: 0x00504e6a, function_type: PhantomData};
...
pub mod bfunit {
    ...
    pub const VALIDATE_POSITION: FunctionDef<unsafe extern "thiscall" fn(*const u32, i8)> = FunctionDef{address: 0x004102fc, function_type: PhantomData};
    ...
    pub const UPDATE_ANIMATION: FunctionDef<unsafe extern "thiscall" fn(*const u32)> = FunctionDef{address: 0x00435bbe, function_type: PhantomData};
    ...
    pub const SET_HEIGHT_ABOVE_TERRAIN: FunctionDef<unsafe extern "thiscall" fn(*const u32)> = FunctionDef{address: 0x00492a51, function_type: PhantomData};
    ...
    pub const SET_DEST_TILE: FunctionDef<unsafe extern "thiscall" fn(*const u32, i32)> = FunctionDef{address: 0x004a7a90, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("bfunit/set_selected"))]
    pub const SET_SELECTED: FunctionDef<unsafe extern "thiscall" fn(*const u32)> = FunctionDef{address: 0x004ee4a4, function_type: PhantomData};
    ...
    pub const BFUNIT: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> *const u32> = FunctionDef{address: 0x004f9c33, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("bfunit/send_event"))]
    pub const SEND_EVENT: FunctionDef<unsafe extern "thiscall" fn(*const u32, u32, u32, u32, u32, u32, u32, u32)> = FunctionDef{address: 0x0059def9, function_type: PhantomData};
    ...
    pub const DRAW_AIINFO: FunctionDef<unsafe extern "thiscall" fn(*const u32, *const i8, i32)> = FunctionDef{address: 0x00602481, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("bfunit/morph"))]
    pub const MORPH: FunctionDef<unsafe extern "thiscall" fn(*const u32)> = FunctionDef{address: 0x00602929, function_type: PhantomData};
...
pub mod bfunittype {
    ...
    pub const LOAD_CHARACTERISTICS_0: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> u32> = FunctionDef{address: 0x004b5de3, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("bfunittype/load_characteristics_1"))]
    pub const LOAD_CHARACTERISTICS_1: FunctionDef<unsafe extern "thiscall" fn(*const u32, *const i32, bool) -> u32> = FunctionDef{address: 0x004b5faf, function_type: PhantomData};
...
pub mod bfversioninfo {
    ...
    pub const EXIT_INSTANCE_0: FunctionDef<unsafe extern "thiscall" fn(*const c_void)> = FunctionDef{address: 0x0057e05d, function_type: PhantomData};
...
pub mod bfwindow {
    ...
    pub const UPDATE: FunctionDef<unsafe extern "thiscall" fn(*const c_void)> = FunctionDef{address: 0x004d60a8, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("bfwindow/show"))]
    pub const SHOW: FunctionDef<unsafe extern "thiscall" fn(*const c_void, i32) -> bool> = FunctionDef{address: 0x004d60ff, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("bfwindow/resize"))]
    pub const RESIZE: FunctionDef<unsafe extern "thiscall" fn(*const c_void, i32, i32)> = FunctionDef{address: 0x004d6141, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("bfwindow/center"))]
    pub const CENTER: FunctionDef<unsafe extern "thiscall" fn(*const c_void)> = FunctionDef{address: 0x004d61db, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("bfwindow/change_style"))]
    pub const CHANGE_STYLE: FunctionDef<unsafe extern "thiscall" fn(*const c_void, *const i32) -> u32> = FunctionDef{address: 0x004d62b3, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("bfwindow/style_popup"))]
    pub const STYLE_POPUP: FunctionDef<unsafe extern "thiscall" fn(*const c_void)> = FunctionDef{address: 0x004d641d, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("bfwindow/style_fixed"))]
    pub const STYLE_FIXED: FunctionDef<unsafe extern "thiscall" fn(*const c_void)> = FunctionDef{address: 0x0052f150, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("bfwindow/pointer"))]
    pub const POINTER: FunctionDef<unsafe extern "thiscall" fn(*const c_void, i32) -> bool> = FunctionDef{address: 0x005336d5, function_type: PhantomData};
...
pub mod bfworldmgr {
    ...
    pub const LOAD: FunctionDef<unsafe extern "thiscall" fn(*const u32, *const u8, u32) -> u32> = FunctionDef{address: 0x0044f280, function_type: PhantomData};
...
pub mod gximage {
    ...
    pub const DRAW: FunctionDef<unsafe extern "thiscall" fn(*const c_void) -> u32> = FunctionDef{address: 0x0061f0c8, function_type: PhantomData};
}
...
pub mod gximagebmp {
    ...
    pub const ATTEMPT: FunctionDef<unsafe extern "thiscall" fn(*const c_void, *const u8) -> u32> = FunctionDef{address: 0x005234da, function_type: PhantomData};
}
...
pub mod gximagetga {
    ...
    pub const ATTEMPT: FunctionDef<unsafe extern "thiscall" fn(*const c_void, *const i8) -> u32> = FunctionDef{address: 0x004b32a7, function_type: PhantomData};
}
...
pub mod httpcallbackinterface {
    ...
    pub const CHECK_COMPLETED: FunctionDef<unsafe extern "thiscall" fn(*const c_void) -> u8> = FunctionDef{address: 0x0059f93f, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("httpcallbackinterface/constructor"))]
    pub const CONSTRUCTOR: FunctionDef<unsafe extern "thiscall" fn(*const c_void) -> *const u32> = FunctionDef{address: 0x00626b1d, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("httpcallbackinterface/notify_done"))]
    pub const NOTIFY_DONE: FunctionDef<unsafe extern "thiscall" fn(*const c_void)> = FunctionDef{address: 0x00626b35, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("httpcallbackinterface/check_error"))]
    pub const CHECK_ERROR: FunctionDef<unsafe extern "thiscall" fn(*const c_void) -> u32> = FunctionDef{address: 0x00626b4f, function_type: PhantomData};
}
...
pub mod sndsoundresource {
    ...
    #[cfg_attr(feature = "detour-validation", validate_detour("sndsoundresource/sndsound_resource"))]
    pub const SNDSOUND_RESOURCE: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> *const u32> = FunctionDef{address: 0x0041e5e3, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("sndsoundresource/attempt"))]
    pub const ATTEMPT: FunctionDef<unsafe extern "thiscall" fn(*const u32, *const i32, *const u8) -> u32> = FunctionDef{address: 0x0061ff52, function_type: PhantomData};
}
...
pub mod sndsoundresourcewav {
    ...
    pub const ATTEMPT: FunctionDef<unsafe extern "thiscall" fn(*const u32, *const i32, *const u8) -> u32> = FunctionDef{address: 0x0041c4c2, function_type: PhantomData};
    ...
    #[cfg_attr(feature = "detour-validation", validate_detour("sndsoundresourcewav/sndsound_resource_wav"))]
    pub const SNDSOUND_RESOURCE_WAV: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> *const u32> = FunctionDef{address: 0x0041e63d, function_type: PhantomData};
}
...
pub mod uibargraphrenderer {
    ...
    pub const RENDER_GRAPH_0: FunctionDef<unsafe extern "thiscall" fn(*const c_void, i32)> = FunctionDef{address: 0x0053211d, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("uibargraphrenderer/point_to_graph_pos"))]
    pub const POINT_TO_GRAPH_POS: FunctionDef<unsafe extern "thiscall" fn(*const c_void, *const i32, *const i32, i32, i32, i32, i32, *const i32, *const i32)> = FunctionDef{address: 0x005324c5, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("uibargraphrenderer/render_xlabels"))]
    pub const RENDER_XLABELS: FunctionDef<unsafe extern "thiscall" fn(*const c_void, *const i32)> = FunctionDef{address: 0x005325f5, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("uibargraphrenderer/render_graph_1"))]
    pub const RENDER_GRAPH_1: FunctionDef<unsafe extern "thiscall" fn(*const c_void, u32)> = FunctionDef{address: 0x006239d9, function_type: PhantomData};
}
...
pub mod uibutton {
    ...
    pub const DRAW: FunctionDef<unsafe extern "thiscall" fn(*const u32, i32, u8)> = FunctionDef{address: 0x004197a0, function_type: PhantomData};
...
pub mod uicontrol {
    ...
    pub const SET_TEXT_0: FunctionDef<unsafe extern "thiscall" fn(*const u32, *const u32, *const u32, i32, i8)> = FunctionDef{address: 0x0040eabf, function_type: PhantomData};
    ...
    pub const DRAW: FunctionDef<unsafe extern "thiscall" fn(*const u32, *const i32, i8)> = FunctionDef{address: 0x004195ae, function_type: PhantomData};
    ...
    pub const FILL_CANVASES: FunctionDef<unsafe extern "thiscall" fn(*const u32, i8) -> u32> = FunctionDef{address: 0x0041bce8, function_type: PhantomData};
    ...
    pub const HANDLE_MOUSE_MOVE: FunctionDef<unsafe extern "thiscall" fn(*const u32, u8) -> u32> = FunctionDef{address: 0x00442493, function_type: PhantomData};
    ...
    pub const HANDLE_LEFT_BUTTON_UP: FunctionDef<unsafe extern "thiscall" fn(*const u32, u32, u32) -> u32> = FunctionDef{address: 0x004435b9, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("uicontrol/handle_left_button_down"))]
    pub const HANDLE_LEFT_BUTTON_DOWN: FunctionDef<unsafe extern "thiscall" fn(*const u32, u8, u32, u32, u32) -> u32> = FunctionDef{address: 0x0044361a, function_type: PhantomData};
    ...
    pub const SET_IMAGE_0: FunctionDef<unsafe extern "thiscall" fn(*const u32, *const u32)> = FunctionDef{address: 0x004b1a32, function_type: PhantomData};
    ...
    pub const LOAD: FunctionDef<unsafe extern "thiscall" fn(*const u32, *const i32, *const u32) -> u32> = FunctionDef{address: 0x004d32c9, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("uicontrol/adjust_dimensions"))]
    pub const ADJUST_DIMENSIONS: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> u32> = FunctionDef{address: 0x004d483e, function_type: PhantomData};
    ...
    pub const UICONTROL: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> *const u32> = FunctionDef{address: 0x004e0996, function_type: PhantomData};
    ...
    pub const GET_TEXT: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> u32> = FunctionDef{address: 0x0058c4aa, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("uicontrol/set_image_1"))]
    pub const SET_IMAGE_1: FunctionDef<unsafe extern "thiscall" fn(*const u32)> = FunctionDef{address: 0x00620b61, function_type: PhantomData};
}
...
pub mod uielement {
    ...
    pub const GET_ELEMENT_0: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> u32> = FunctionDef{address: 0x0040760c, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("uielement/sort"))]
    pub const SORT: FunctionDef<unsafe extern "thiscall" fn(*const u32)> = FunctionDef{address: 0x0040eab5, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("uielement/load_state"))]
    pub const LOAD_STATE: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> u8> = FunctionDef{address: 0x0041215f, function_type: PhantomData};
    ...
    pub const UPDATE: FunctionDef<unsafe extern "thiscall" fn(*const u32, i32)> = FunctionDef{address: 0x0041adf1, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("uielement/handle_double_click"))]
    pub const HANDLE_DOUBLE_CLICK: FunctionDef<unsafe extern "thiscall" fn(*const u32)> = FunctionDef{address: 0x0041eabe, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("uielement/handle_middle_button_down"))]
    pub const HANDLE_MIDDLE_BUTTON_DOWN: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> u32> = FunctionDef{address: 0x00429d0f, function_type: PhantomData};
    ...
    pub const HANDLE_LEFT_BUTTON_UP: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> u32> = FunctionDef{address: 0x004435a8, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("uielement/handle_left_button_down"))]
    pub const HANDLE_LEFT_BUTTON_DOWN: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> u32> = FunctionDef{address: 0x0044360a, function_type: PhantomData};
    ...
    pub const RELOAD: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> u8> = FunctionDef{address: 0x004d5777, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("uielement/handle_mouse_wheel"))]
    pub const HANDLE_MOUSE_WHEEL: FunctionDef<unsafe extern "thiscall" fn(*const u32, u8, u8, u8, u32) -> u32> = FunctionDef{address: 0x004de381, function_type: PhantomData};
    ...
    pub const SET_GLOBAL_GRAYED: FunctionDef<unsafe extern "thiscall" fn(*const u32)> = FunctionDef{address: 0x005a0d64, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("uielement/handle_key_down"))]
    pub const HANDLE_KEY_DOWN: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> u32> = FunctionDef{address: 0x00606ce7, function_type: PhantomData};
}
...
pub mod uigraphrenderer {
    ...
    pub const CALC_DISPLAY_RANGES: FunctionDef<unsafe extern "thiscall" fn(*const c_void)> = FunctionDef{address: 0x0052f46b, function_type: PhantomData};
    ...
    pub const RENDER: FunctionDef<unsafe extern "thiscall" fn(*const c_void)> = FunctionDef{address: 0x00531dbd, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("uigraphrenderer/render_point_label"))]
    pub const RENDER_POINT_LABEL: FunctionDef<unsafe extern "thiscall" fn(*const c_void, *const u32, *const i32, *const u8, i32, i32)> = FunctionDef{address: 0x00531ec5, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("uigraphrenderer/render_labels"))]
    pub const RENDER_LABELS: FunctionDef<unsafe extern "thiscall" fn(*const c_void, u32)> = FunctionDef{address: 0x005325da, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("uigraphrenderer/render_axis_lines"))]
    pub const RENDER_AXIS_LINES: FunctionDef<unsafe extern "thiscall" fn(*const c_void)> = FunctionDef{address: 0x005328f4, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("uigraphrenderer/render_ylabels"))]
    pub const RENDER_YLABELS: FunctionDef<unsafe extern "thiscall" fn(*const c_void, *const i32)> = FunctionDef{address: 0x0053296d, function_type: PhantomData};
}
...
pub mod uiimage {
    ...
    pub const CREATE: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> *const u32> = FunctionDef{address: 0x00606fd2, function_type: PhantomData};
}
...
pub mod uiimageset {
    ...
    pub const SET_STATUS: FunctionDef<unsafe extern "thiscall" fn(*const c_void, i32, i32, i32)> = FunctionDef{address: 0x004f1b13, function_type: PhantomData};
}
...
pub mod uilayout {
    ...
    pub const DRAW: FunctionDef<unsafe extern "thiscall" fn(*const u32, *const i32, u32)> = FunctionDef{address: 0x0041952b, function_type: PhantomData};
    ...
    pub const HANDLE_LEFT_BUTTON_UP: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> u32> = FunctionDef{address: 0x0058c88e, function_type: PhantomData};
...
pub mod uilistbox {
    ...
    pub const LOAD: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> u32> = FunctionDef{address: 0x004d393f, function_type: PhantomData};
    ...
    #[cfg_attr(feature = "detour-validation", validate_detour("uilistbox/scroll"))]
    pub const SCROLL: FunctionDef<unsafe extern "thiscall" fn(*const u32, i32) -> u32> = FunctionDef{address: 0x0053337e, function_type: PhantomData};
...
pub mod uimessagequeue {
    ...
    pub const DRAW: FunctionDef<unsafe extern "thiscall" fn(*const u32, i32, i8)> = FunctionDef{address: 0x004197fc, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("uimessagequeue/add_message"))]
    pub const ADD_MESSAGE: FunctionDef<unsafe extern "thiscall" fn(*const u32, u32, i32, *const u32, *const u32, bool, bool) -> u32> = FunctionDef{address: 0x0049cd46, function_type: PhantomData};
...
pub mod uipointgraphrenderer {
    ...
    pub const RENDER_GRAPH: FunctionDef<unsafe extern "thiscall" fn(*const c_void, *const i32)> = FunctionDef{address: 0x00623eb8, function_type: PhantomData};
}
...
pub mod uiscrollingregion {
    ...
    pub const LOAD: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> u32> = FunctionDef{address: 0x004d3e23, function_type: PhantomData};
    ...
    pub const HANDLE_CHAR: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> u32> = FunctionDef{address: 0x00622ef8, function_type: PhantomData};
...
pub mod uistatusimage {
    ...
    pub const SET_STATUS: FunctionDef<unsafe extern "thiscall" fn(*const c_void, i32, i32, i32)> = FunctionDef{address: 0x0041cefc, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("uistatusimage/clear_for_load"))]
    pub const CLEAR_FOR_LOAD: FunctionDef<unsafe extern "thiscall" fn(*const c_void)> = FunctionDef{address: 0x004d3de0, function_type: PhantomData};
}
...
pub mod uitext {
    ...
    #[cfg_attr(feature = "detour-validation", validate_detour("uitext/set_text"))]
    pub const SET_TEXT: FunctionDef<unsafe extern "thiscall" fn(*const u32, *const u32) -> *const u32> = FunctionDef{address: 0x0040495e, function_type: PhantomData};
...
pub mod uiview {
    ...
    pub const CONSTRUCTOR_0: FunctionDef<unsafe extern "thiscall" fn(*const c_void) -> *const u32> = FunctionDef{address: 0x0052059c, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("uiview/copy"))]
    pub const COPY: FunctionDef<unsafe extern "thiscall" fn(*const c_void) -> *const u32> = FunctionDef{address: 0x0060a8d2, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("uiview/constructor_1"))]
    pub const CONSTRUCTOR_1: FunctionDef<unsafe extern "thiscall" fn(*const c_void, *const i32) -> *const u32> = FunctionDef{address: 0x00620a90, function_type: PhantomData};
}
...
pub mod updatehandler {
    ...
    pub const PARSE_INDEX_0: FunctionDef<unsafe extern "thiscall" fn(*const c_void)> = FunctionDef{address: 0x004ab2f7, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("updatehandler/constructor"))]
    pub const CONSTRUCTOR: FunctionDef<unsafe extern "thiscall" fn(*const c_void) -> *const u32> = FunctionDef{address: 0x00624e20, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("updatehandler/prune_update_groups"))]
    pub const PRUNE_UPDATE_GROUPS: FunctionDef<unsafe extern "stdcall" fn(*const i32)> = FunctionDef{address: 0x00624fb6, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("updatehandler/destination_from_url"))]
    pub const DESTINATION_FROM_URL: FunctionDef<unsafe extern "stdcall" fn(*const u32, *const u32, i8) -> *const u32> = FunctionDef{address: 0x0062534b, function_type: PhantomData};
    ...
    pub const FINALIZE_UPDATES: FunctionDef<unsafe extern "thiscall" fn(*const c_void)> = FunctionDef{address: 0x00625907, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("updatehandler/move_file_from_tmp"))]
    pub const MOVE_FILE_FROM_TMP: FunctionDef<unsafe extern "thiscall" fn(*const c_void)> = FunctionDef{address: 0x00625a9b, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("updatehandler/parse_index_1"))]
    pub const PARSE_INDEX_1: FunctionDef<unsafe extern "thiscall" fn(*const c_void, i32, *const c_void)> = FunctionDef{address: 0x00625d13, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("updatehandler/start_index_download"))]
    pub const START_INDEX_DOWNLOAD: FunctionDef<unsafe extern "thiscall" fn(*const c_void)> = FunctionDef{address: 0x00626205, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("updatehandler/start_download"))]
    pub const START_DOWNLOAD: FunctionDef<unsafe extern "thiscall" fn(*const c_void, *const i8)> = FunctionDef{address: 0x00626247, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("updatehandler/download_file_group"))]
    pub const DOWNLOAD_FILE_GROUP: FunctionDef<unsafe extern "thiscall" fn(*const c_void, *const i32)> = FunctionDef{address: 0x00626350, function_type: PhantomData};
    ...
    #[cfg_attr(feature = "detour-validation", validate_detour("updatehandler/cancel_download"))]
    pub const CANCEL_DOWNLOAD: FunctionDef<unsafe extern "fastcall" fn(i32)> = FunctionDef{address: 0x006265a0, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("updatehandler/notify_done"))]
    pub const NOTIFY_DONE: FunctionDef<unsafe extern "thiscall" fn(*const c_void)> = FunctionDef{address: 0x006265c3, function_type: PhantomData};
}
...
pub mod ztaimgr {
    ...
    pub const ZTAIMGR: FunctionDef<unsafe extern "thiscall" fn(*const u32, u8) -> *const u32> = FunctionDef{address: 0x00503857, function_type: PhantomData};
...
pub mod ztadvterrainmgr {
    ...
    pub const UPDATE: FunctionDef<unsafe extern "thiscall" fn(*const u32, i32)> = FunctionDef{address: 0x00419e14, function_type: PhantomData};
    ...
    pub const SET_IMAGE: FunctionDef<unsafe extern "thiscall" fn(*const u32, *const i32, *const i32, *const i32) -> u32> = FunctionDef{address: 0x004aede5, function_type: PhantomData};
...
pub mod ztambient {
    ...
    pub const CALC_SHADOW_WORLD_POSITION: FunctionDef<unsafe extern "thiscall" fn(*const u32)> = FunctionDef{address: 0x00433cad, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("ztambient/update_position"))]
    pub const UPDATE_POSITION: FunctionDef<unsafe extern "thiscall" fn(*const u32, i32)> = FunctionDef{address: 0x00434e9c, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("ztambient/load"))]
    pub const LOAD: FunctionDef<unsafe extern "thiscall" fn(*const u32, *const u8, u32) -> u32> = FunctionDef{address: 0x00450261, function_type: PhantomData};
    ...
    pub const INIT: FunctionDef<unsafe extern "thiscall" fn(*const u32)> = FunctionDef{address: 0x004fc145, function_type: PhantomData};
...
pub mod ztambienttype {
    ...
    pub const LOAD_CHARACTERISTICS: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> u8> = FunctionDef{address: 0x004c2ec9, function_type: PhantomData};
...
pub mod ztanimal {
    ...
    pub const GET_HABITAT_RATING: FunctionDef<unsafe extern "thiscall" fn(*const u32, *const u32) -> i64> = FunctionDef{address: 0x00411afd, function_type: PhantomData};
    ...
    pub const GET_IDLE_ANIM: FunctionDef<unsafe extern "thiscall" fn(*const u32, i8) -> i32> = FunctionDef{address: 0x00413582, function_type: PhantomData};
    ...
    pub const IS_WALKABLE_BY: FunctionDef<unsafe extern "thiscall" fn(*const u32, u32) -> u32> = FunctionDef{address: 0x00431696, function_type: PhantomData};
    ...
    pub const DRAW: FunctionDef<unsafe extern "thiscall" fn(*const u32, *const i32, i32, i32, i32, *const u8)> = FunctionDef{address: 0x00433933, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("ztanimal/update"))]
    pub const UPDATE: FunctionDef<unsafe extern "thiscall" fn(*const u32, i32)> = FunctionDef{address: 0x00436f11, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("ztanimal/update_position"))]
    pub const UPDATE_POSITION: FunctionDef<unsafe extern "thiscall" fn(*const u32)> = FunctionDef{address: 0x00436f32, function_type: PhantomData};
    ...
    pub const DO_AMBIENT_ANIMS: FunctionDef<unsafe extern "thiscall" fn(*const u32)> = FunctionDef{address: 0x00437102, function_type: PhantomData};
    ...
    pub const LOAD: FunctionDef<unsafe extern "thiscall" fn(*const u32, *const u8, u32) -> u32> = FunctionDef{address: 0x00455533, function_type: PhantomData};
    ...
    pub const SET_NAME: FunctionDef<unsafe extern "thiscall" fn(*const u32)> = FunctionDef{address: 0x004e1d6b, function_type: PhantomData};
    ...
    pub const ZTANIMAL_0: FunctionDef<unsafe extern "thiscall" fn(*const u32, u8) -> *const u32> = FunctionDef{address: 0x004f9d83, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("ztanimal/ztanimal_1"))]
    pub const ZTANIMAL_1: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> *const u32> = FunctionDef{address: 0x004f9dac, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("ztanimal/ztanimal_2"))]
    pub const ZTANIMAL_2: FunctionDef<unsafe extern "thiscall" fn(*const u32, u8) -> *const u32> = FunctionDef{address: 0x004f9e18, function_type: PhantomData};
    ...
    pub const REMOVE_FROM_MAP: FunctionDef<unsafe extern "thiscall" fn(*const u32)> = FunctionDef{address: 0x004fe296, function_type: PhantomData};
    ...
    pub const DRAW_AIINFO: FunctionDef<unsafe extern "thiscall" fn(*const u32, *const u32, i32, i32)> = FunctionDef{address: 0x00613641, function_type: PhantomData};
...
pub mod ztanimaltype {
    ...
    pub const LOAD_CHARACTERISTICS_0: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> u8> = FunctionDef{address: 0x004b659e, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("ztanimaltype/load_characteristics_1"))]
    pub const LOAD_CHARACTERISTICS_1: FunctionDef<unsafe extern "thiscall" fn(*const u32, *const i32, i8) -> u32> = FunctionDef{address: 0x004b6c51, function_type: PhantomData};
    ...
    pub const ZTANIMAL_TYPE: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> *const u32> = FunctionDef{address: 0x00500be5, function_type: PhantomData};
}
...
pub mod ztapp {
    ...
    pub const UPDATE_UI: FunctionDef<unsafe extern "thiscall" fn(*const u32, i32)> = FunctionDef{address: 0x00419d8c, function_type: PhantomData};
    ...
    pub const UPDATE_SIM: FunctionDef<unsafe extern "thiscall" fn(*const u32, i32)> = FunctionDef{address: 0x0041a6d1, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("ztapp/get_screen_center"))]
    pub const GET_SCREEN_CENTER: FunctionDef<unsafe extern "thiscall" fn(*const u32)> = FunctionDef{address: 0x0043f30d, function_type: PhantomData};
    ...
    pub const INIT_INSTANCE: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> u32> = FunctionDef{address: 0x004bc17f, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("ztapp/restart_graphics_mgr"))]
    pub const RESTART_GRAPHICS_MGR: FunctionDef<unsafe extern "thiscall" fn(*const u32, i8) -> u32> = FunctionDef{address: 0x004caa0f, function_type: PhantomData};
    ...
    pub const RESIZE_APP: FunctionDef<unsafe extern "thiscall" fn(*const u32, i32, i32)> = FunctionDef{address: 0x004d6dce, function_type: PhantomData};
...
pub mod ztassignhabitatmode {
    ...
    pub const CHECK_MOUSE_OVER_ENTITY: FunctionDef<unsafe extern "thiscall" fn(*const c_void)> = FunctionDef{address: 0x00471d52, function_type: PhantomData};
}
...
pub mod ztbuilding {
    ...
    pub const UPDATE: FunctionDef<unsafe extern "thiscall" fn(*const u32, *const i32)> = FunctionDef{address: 0x00434c4b, function_type: PhantomData};
    ...
    pub const LOAD: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> u8> = FunctionDef{address: 0x0045184a, function_type: PhantomData};
    ...
    pub const REMOVE_FROM_MAP: FunctionDef<unsafe extern "thiscall" fn(*const u32, i8)> = FunctionDef{address: 0x0050023a, function_type: PhantomData};
...
pub mod ztbuildingtype {
    ...
    pub const LOAD_CHARACTERISTICS: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> u32> = FunctionDef{address: 0x004c042c, function_type: PhantomData};
...
pub mod ztfence {
    ...
    pub const GET_ESTHETIC_BONUS: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> *const i32> = FunctionDef{address: 0x0041fb50, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("ztfence/update_animation"))]
    pub const UPDATE_ANIMATION: FunctionDef<unsafe extern "thiscall" fn(*const u32)> = FunctionDef{address: 0x00434ad7, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("ztfence/update"))]
    pub const UPDATE: FunctionDef<unsafe extern "thiscall" fn(*const u32, i32)> = FunctionDef{address: 0x00434b1d, function_type: PhantomData};
    ...
    pub const VALIDATE_POSITION: FunctionDef<unsafe extern "thiscall" fn(*const u32, i8)> = FunctionDef{address: 0x00449fb2, function_type: PhantomData};
    ...
    pub const LOAD: FunctionDef<unsafe extern "thiscall" fn(*const u32, *const u8, u32) -> u32> = FunctionDef{address: 0x0044ff2d, function_type: PhantomData};
    ...
    pub const MORPH: FunctionDef<unsafe extern "thiscall" fn(*const u32, *const i32)> = FunctionDef{address: 0x0048676c, function_type: PhantomData};
    ...
    pub const REMOVE_FROM_MAP: FunctionDef<unsafe extern "thiscall" fn(*const u32)> = FunctionDef{address: 0x004ffd6e, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("ztfence/init_after_load"))]
    pub const INIT_AFTER_LOAD: FunctionDef<unsafe extern "thiscall" fn(*const u32, u8, u32)> = FunctionDef{address: 0x00594060, function_type: PhantomData};
...
pub mod ztfencetype {
    ...
    pub const LOAD_CHARACTERISTICS_0: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> u32> = FunctionDef{address: 0x004bb6f6, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("ztfencetype/load_characteristics_1"))]
    pub const LOAD_CHARACTERISTICS_1: FunctionDef<unsafe extern "thiscall" fn(*const u32, *const i32) -> u32> = FunctionDef{address: 0x004bb8ed, function_type: PhantomData};
    ...
    pub const ZTFENCE_TYPE: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> *const u32> = FunctionDef{address: 0x0050118e, function_type: PhantomData};
...
pub mod ztfood {
    ...
    pub const ZTFOOD_0: FunctionDef<unsafe extern "thiscall" fn(*const u32, u8) -> *const u32> = FunctionDef{address: 0x0041e080, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("ztfood/ztfood_1"))]
    pub const ZTFOOD_1: FunctionDef<unsafe extern "thiscall" fn(*const u32, u8) -> *const u32> = FunctionDef{address: 0x004f9f46, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("ztfood/ztfood_2"))]
    pub const ZTFOOD_2: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> *const u32> = FunctionDef{address: 0x004f9f64, function_type: PhantomData};
...
pub mod ztfoodtype {
    ...
    pub const LOAD_CHARACTERISTICS: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> u8> = FunctionDef{address: 0x004c2473, function_type: PhantomData};
...
pub mod ztgamemgr {
    ...
    pub const UPDATE: FunctionDef<unsafe extern "thiscall" fn(*const u32, i32)> = FunctionDef{address: 0x0041a154, function_type: PhantomData};
    ...
    pub const SET_NEW_GAME_DEFAULTS: FunctionDef<unsafe extern "thiscall" fn(*const u32, *const c_void, i8)> = FunctionDef{address: 0x0058f39c, function_type: PhantomData};
    ...
    pub const LOAD: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> u8> = FunctionDef{address: 0x005948c6, function_type: PhantomData};
}
...
pub mod ztgoalavoid {
    ...
    pub const ZTGOAL_AVOID_0: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> *const u32> = FunctionDef{address: 0x0041226c, function_type: PhantomData};
    ...
    pub const ZTGOAL_AVOID_1: FunctionDef<unsafe extern "thiscall" fn(*const u32, u8) -> *const u32> = FunctionDef{address: 0x00604185, function_type: PhantomData};
}
...
pub mod ztgoalbagdoo {
    ...
    pub const COMPLETE: FunctionDef<unsafe extern "thiscall" fn(*const c_void, f32)> = FunctionDef{address: 0x004a2c98, function_type: PhantomData};
}
...
pub mod ztgoalbuildingexit {
    ...
    pub const COMPLETE: FunctionDef<unsafe extern "thiscall" fn(*const c_void)> = FunctionDef{address: 0x0042dddf, function_type: PhantomData};
}
...
pub mod ztgoalchase {
    ...
    pub const GET_TYPE: FunctionDef<unsafe extern "thiscall" fn(*const c_void) -> u32> = FunctionDef{address: 0x004a4c06, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("ztgoalchase/check_done"))]
    pub const CHECK_DONE: FunctionDef<unsafe extern "thiscall" fn(*const c_void)> = FunctionDef{address: 0x004a4c0c, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("ztgoalchase/decide"))]
    pub const DECIDE: FunctionDef<unsafe extern "thiscall" fn(*const c_void)> = FunctionDef{address: 0x004a4d6c, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("ztgoalchase/ztgoal_chase"))]
    pub const ZTGOAL_CHASE: FunctionDef<unsafe extern "thiscall" fn(*const c_void, u8)> = FunctionDef{address: 0x004a4d98, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("ztgoalchase/complete"))]
    pub const COMPLETE: FunctionDef<unsafe extern "thiscall" fn(*const c_void)> = FunctionDef{address: 0x004a4dd2, function_type: PhantomData};
...
pub mod ztgoalchaseanimal {
    ...
    pub const COMPLETE: FunctionDef<unsafe extern "thiscall" fn(*const c_void)> = FunctionDef{address: 0x0050db25, function_type: PhantomData};
}
...
pub mod ztgoalemptytrash {
    ...
    pub const INIT: FunctionDef<unsafe extern "thiscall" fn(*const c_void) -> u32> = FunctionDef{address: 0x0048b3f2, function_type: PhantomData};
}
...
pub mod ztgoalfactory {
    ...
    pub const CREATE_SUB: FunctionDef<unsafe extern "thiscall" fn(*const c_void, u32) -> *const u32> = FunctionDef{address: 0x00413aa7, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("ztgoalfactory/create"))]
    pub const CREATE: FunctionDef<unsafe extern "thiscall" fn(*const c_void, u32) -> *const u32> = FunctionDef{address: 0x00413bec, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("ztgoalfactory/constructor"))]
    pub const CONSTRUCTOR: FunctionDef<unsafe extern "thiscall" fn(*const c_void) -> *const c_void> = FunctionDef{address: 0x00603e6b, function_type: PhantomData};
}
...
pub mod ztgoalgawk {
    ...
    pub const COMPLETE: FunctionDef<unsafe extern "thiscall" fn(*const c_void)> = FunctionDef{address: 0x0042e9f9, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("ztgoalgawk/left_va"))]
    pub const LEFT_VA: FunctionDef<unsafe extern "thiscall" fn(*const c_void)> = FunctionDef{address: 0x0042ea14, function_type: PhantomData};
}
...
pub mod ztgoalpreattack {
    ...
    pub const INIT: FunctionDef<unsafe extern "thiscall" fn(*const c_void) -> u32> = FunctionDef{address: 0x0061b2d6, function_type: PhantomData};
}
...
pub mod ztgoalwaterdrown {
    ...
    pub const INIT: FunctionDef<unsafe extern "thiscall" fn(*const c_void) -> u8> = FunctionDef{address: 0x0061a705, function_type: PhantomData};
}
...
pub mod ztgoalzoodoo {
    ...
    pub const GET_TYPE: FunctionDef<unsafe extern "thiscall" fn(*const c_void) -> u32> = FunctionDef{address: 0x004a2746, function_type: PhantomData};
}
...
pub mod ztguest {
    ...
    pub const CHECK_PREDATOR: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> u32> = FunctionDef{address: 0x004302ea, function_type: PhantomData};
    ...
    pub const ZTGUEST: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> *const u32> = FunctionDef{address: 0x004fa44c, function_type: PhantomData};
...
pub mod ztguesttype {
    ...
    pub const LOAD_CHARACTERISTICS_0: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> u8> = FunctionDef{address: 0x004c47dd, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("ztguesttype/load_characteristics_1"))]
    pub const LOAD_CHARACTERISTICS_1: FunctionDef<unsafe extern "thiscall" fn(*const u32, *const u32) -> u32> = FunctionDef{address: 0x004c4cb9, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("ztguesttype/ztguest_type"))]
    pub const ZTGUEST_TYPE: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> *const u32> = FunctionDef{address: 0x004cbb9c, function_type: PhantomData};
...
pub mod ztguidetype {
    ...
    pub const LOAD_CHARACTERISTICS_0: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> u32> = FunctionDef{address: 0x004c3ee2, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("ztguidetype/load_characteristics_1"))]
    pub const LOAD_CHARACTERISTICS_1: FunctionDef<unsafe extern "thiscall" fn(*const u32, *const i32) -> u32> = FunctionDef{address: 0x004c406f, function_type: PhantomData};
...
pub mod zthabitat {
    ...
    pub const GET_HABITAT_RATING: FunctionDef<unsafe extern "thiscall" fn(*const u32, *const f32, i32, i8) -> f32> = FunctionDef{address: 0x00415dd7, function_type: PhantomData};
    ...
    pub const UPDATE: FunctionDef<unsafe extern "thiscall" fn(*const u32, i32)> = FunctionDef{address: 0x004357c6, function_type: PhantomData};
...
pub mod zthabitatmgr {
    ...
    pub const ZTHABITAT_MGR: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> *const u32> = FunctionDef{address: 0x0050363d, function_type: PhantomData};
...
pub mod zthelicopter {
    ...
    pub const INIT_AFTER_LOAD: FunctionDef<unsafe extern "thiscall" fn(*const u32, u8, u32)> = FunctionDef{address: 0x00482cf1, function_type: PhantomData};
    ...
    pub const SET_DEST_TILE: FunctionDef<unsafe extern "thiscall" fn(*const u32, i32)> = FunctionDef{address: 0x0061a117, function_type: PhantomData};
}
...
pub mod zthelicoptertype {
    ...
    pub const LOAD_CHARACTERISTICS: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> u32> = FunctionDef{address: 0x004c42ff, function_type: PhantomData};
...
pub mod ztkeeper {
    ...
    pub const REMOVE_FROM_MAP: FunctionDef<unsafe extern "thiscall" fn(*const u32, u32)> = FunctionDef{address: 0x00458759, function_type: PhantomData};
...
pub mod ztkeepertype {
    ...
    pub const LOAD_CHARACTERISTICS_0: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> u8> = FunctionDef{address: 0x004c32bd, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("ztkeepertype/load_characteristics_1"))]
    pub const LOAD_CHARACTERISTICS_1: FunctionDef<unsafe extern "thiscall" fn(*const u32, *const i32) -> u32> = FunctionDef{address: 0x004c34ae, function_type: PhantomData};
...
pub mod ztmvtempentitylist {
    ...
    pub const CLEAR: FunctionDef<unsafe extern "thiscall" fn(*const c_void)> = FunctionDef{address: 0x00443e12, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("ztmvtempentitylist/add_entity"))]
    pub const ADD_ENTITY: FunctionDef<unsafe extern "thiscall" fn(*const c_void, u32, *const i32) -> *const u32> = FunctionDef{address: 0x004df44e, function_type: PhantomData};
}
...
pub mod ztmainttype {
    ...
    pub const LOAD_CHARACTERISTICS_0: FunctionDef<unsafe extern "thiscall" fn(*const i32) -> u8> = FunctionDef{address: 0x004c3bb3, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("ztmainttype/load_characteristics_1"))]
    pub const LOAD_CHARACTERISTICS_1: FunctionDef<unsafe extern "thiscall" fn(*const i32, *const i32) -> u32> = FunctionDef{address: 0x004c3d44, function_type: PhantomData};
...
pub mod ztmapview {
    ...
    pub const DRAW: FunctionDef<unsafe extern "thiscall" fn(*const u32, *const i32, i8)> = FunctionDef{address: 0x00419729, function_type: PhantomData};
    ...
    pub const HANDLE_CHAR: FunctionDef<unsafe extern "thiscall" fn(*const u32, i32) -> u32> = FunctionDef{address: 0x0046bd7d, function_type: PhantomData};
    ...
    pub const LOAD: FunctionDef<unsafe extern "thiscall" fn(*const u32, *const i32, *const u32) -> u32> = FunctionDef{address: 0x004d3f9e, function_type: PhantomData};
    ...
    pub const HANDLE_KEY_UP: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> u32> = FunctionDef{address: 0x004f0b1e, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("ztmapview/handle_key_down"))]
    pub const HANDLE_KEY_DOWN: FunctionDef<unsafe extern "thiscall" fn(*const u32, i32) -> u32> = FunctionDef{address: 0x004f0ee4, function_type: PhantomData};
    ...
    pub const HANDLE_RIGHT_BUTTON_DOWN: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> u32> = FunctionDef{address: 0x004f95e4, function_type: PhantomData};
    ...
    pub const HANDLE_RIGHT_BUTTON_UP: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> u32> = FunctionDef{address: 0x004f96fd, function_type: PhantomData};
    ...
    pub const LOAD_STATE: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> bool> = FunctionDef{address: 0x00592907, function_type: PhantomData};
...
pub mod ztminimap {
    ...
    pub const UPDATE: FunctionDef<unsafe extern "thiscall" fn(*const u32)> = FunctionDef{address: 0x004445ca, function_type: PhantomData};
...
pub mod ztpathtype {
    ...
    pub const LOAD_CHARACTERISTICS: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> u8> = FunctionDef{address: 0x004c24cf, function_type: PhantomData};
...
pub mod ztresearchbranch {
    ...
    pub const DAYS_REMAINING_ON_PROGRAM: FunctionDef<unsafe extern "thiscall" fn(*const u32)> = FunctionDef{address: 0x004eb1bf, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("ztresearchbranch/pct_remaining_on_program"))]
    pub const PCT_REMAINING_ON_PROGRAM: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> i64> = FunctionDef{address: 0x004eb1f2, function_type: PhantomData};
...
pub mod ztresearchmgr {
    ...
    pub const UPDATE: FunctionDef<unsafe extern "thiscall" fn(*const u32, i32) -> i32> = FunctionDef{address: 0x00435a6f, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("ztresearchmgr/save"))]
    pub const SAVE: FunctionDef<unsafe extern "thiscall" fn(*const u32, *const u32) -> bool> = FunctionDef{address: 0x0047a923, function_type: PhantomData};
    ...
    // Confirmed against ZTResearchMgr_load.asm: the function ends `RET 0x8`, popping 2 stack dwords
    // beyond `this`/ECX. Param 1 is the file/stream pointer (passed straight through to `deallocate`
    // as its 4th arg). Param 2 is a version value: `CMP [param2], 0x28; JC <skip>` gates whether the
    // saved-records stream is read at all (records are only read when `param2 >= 0x28`).
...
pub mod ztresearchprogram {
    ...
    pub const ON_COMPLETION: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> u32> = FunctionDef{address: 0x0058fb83, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("ztresearchprogram/reset"))]
    pub const RESET: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> u32> = FunctionDef{address: 0x005900d8, function_type: PhantomData};
...
pub mod ztrubbletype {
    ...
    pub const LOAD_CHARACTERISTICS: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> u32> = FunctionDef{address: 0x004c42a2, function_type: PhantomData};
...
pub mod ztscenariomgr {
    ...
    pub const BEGIN_SCENARIO: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> u32> = FunctionDef{address: 0x004c998b, function_type: PhantomData};
...
pub mod ztscenariotimer {
    ...
    pub const SIZE: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> u32> = FunctionDef{address: 0x004113d7, function_type: PhantomData};
    ...
    pub const LOAD: FunctionDef<unsafe extern "thiscall" fn(*const u32, *const u8, u32, i32)> = FunctionDef{address: 0x005950ab, function_type: PhantomData};
    ...
    pub const LOAD_STATE: FunctionDef<unsafe extern "thiscall" fn(*const u32, *const u32)> = FunctionDef{address: 0x0061c430, function_type: PhantomData};
}
...
pub mod ztscenerytype {
    ...
    pub const IS_SNAP_TO_GROUND: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> u8> = FunctionDef{address: 0x004104ca, function_type: PhantomData};
    ...
    pub const ZTSCENERY_0: FunctionDef<unsafe extern "thiscall" fn(*const u32, i32) -> *const u32> = FunctionDef{address: 0x0041294b, function_type: PhantomData};
    ...
    pub const ZTSCENERY_1: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> *const u32> = FunctionDef{address: 0x0041e075, function_type: PhantomData};
    ...
    pub const LOAD_CHARACTERISTICS: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> u32> = FunctionDef{address: 0x004ba5b0, function_type: PhantomData};
    ...
    pub const ZTSCENERY_TYPE: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> *const u32> = FunctionDef{address: 0x00501080, function_type: PhantomData};
...
pub mod ztshow {
    ...
    pub const STOP_0: FunctionDef<unsafe extern "thiscall" fn(*const u32)> = FunctionDef{address: 0x005a3db4, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("ztshow/stop_1"))]
    pub const STOP_1: FunctionDef<unsafe extern "thiscall" fn(*const u32, u32)> = FunctionDef{address: 0x005a4057, function_type: PhantomData};
    ...
    pub const START: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> u32> = FunctionDef{address: 0x005a85e9, function_type: PhantomData};
...
pub mod ztstaff {
    ...
    pub const ZTSTAFF: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> *const u32> = FunctionDef{address: 0x004f9d09, function_type: PhantomData};
...
pub mod ztstafftype {
    ...
    pub const LOAD_CHARACTERISTICS_0: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> u32> = FunctionDef{address: 0x004c3081, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("ztstafftype/load_characteristics_1"))]
    pub const LOAD_CHARACTERISTICS_1: FunctionDef<unsafe extern "thiscall" fn(*const u32, *const i32) -> u32> = FunctionDef{address: 0x004c3783, function_type: PhantomData};
    ...
    pub const ZTSTAFF_TYPE: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> *const u32> = FunctionDef{address: 0x0057ca11, function_type: PhantomData};
...
pub mod zttankexhibit {
    ...
    pub const ZTTANK_EXHIBIT: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> *const u32> = FunctionDef{address: 0x00505148, function_type: PhantomData};
...
pub mod zttankfiltertype {
    ...
    pub const LOAD_CHARACTERISTICS: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> u32> = FunctionDef{address: 0x004c44aa, function_type: PhantomData};
...
pub mod zttankwall {
    ...
    pub const MORPH: FunctionDef<unsafe extern "thiscall" fn(*const u32)> = FunctionDef{address: 0x004868a9, function_type: PhantomData};
...
pub mod zttankwalltype {
    ...
    pub const LOAD_CHARACTERISTICS: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> u8> = FunctionDef{address: 0x004c2c4d, function_type: PhantomData};
...
// ZTTerraformMode_old class functions
pub mod ztterraformmode_old {
    use super::*;

    #[cfg_attr(feature = "detour-validation", validate_detour("ztterraformmode_old/commit_terraform"))]
    pub const COMMIT_TERRAFORM: FunctionDef<unsafe extern "thiscall" fn(*const c_void, i8)> = FunctionDef{address: 0x004da252, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("ztterraformmode_old/hilite_habitats"))]
    pub const HILITE_HABITATS: FunctionDef<unsafe extern "thiscall" fn(*const c_void)> = FunctionDef{address: 0x004dc362, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("ztterraformmode_old/do_terrain_paint"))]
    pub const DO_TERRAIN_PAINT: FunctionDef<unsafe extern "thiscall" fn(*const c_void, i32, i32, bool)> = FunctionDef{address: 0x004dce9a, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("ztterraformmode_old/cancel_terraform"))]
    pub const CANCEL_TERRAFORM: FunctionDef<unsafe extern "thiscall" fn(*const c_void)> = FunctionDef{address: 0x00619368, function_type: PhantomData};
}
...
pub mod ztthought {
    ...
    pub const CONSTRUCTOR: FunctionDef<unsafe extern "thiscall" fn(*const c_void, u32, i32, i32, i32) -> *const u32> = FunctionDef{address: 0x00423043, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("ztthought/get_string"))]
    pub const GET_STRING: FunctionDef<unsafe extern "thiscall" fn(*const c_void, *const u32) -> *const u32> = FunctionDef{address: 0x004edbfc, function_type: PhantomData};
}
...
pub mod ztthoughtmgr {
    ...
    pub const ZTTHOUGHT_MGR: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> *const u32> = FunctionDef{address: 0x0057d815, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("ztthoughtmgr/load"))]
    pub const LOAD: FunctionDef<unsafe extern "thiscall" fn(*const u32, *const u8, u32) -> bool> = FunctionDef{address: 0x0059435b, function_type: PhantomData};
}
...
pub mod ztui_staffinfo {
    ...
    pub const FORCE_UPDATE: FunctionDef<unsafe extern "thiscall" fn(*const c_void)> = FunctionDef{address: 0x005b0f93, function_type: PhantomData};
...
pub mod ztundobuffer {
    ...
    pub const CLEAR: FunctionDef<unsafe extern "thiscall" fn(*const c_void, i8)> = FunctionDef{address: 0x004f15c8, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("ztundobuffer/add_action"))]
    pub const ADD_ACTION: FunctionDef<unsafe extern "thiscall" fn(*const c_void, i32, u32, u32, *const u32, u32, u32, u32, u32, u32, *const i32, *const u32, i32, i32)> = FunctionDef{address: 0x004f8a1f, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("ztundobuffer/remove_action"))]
    pub const REMOVE_ACTION: FunctionDef<unsafe extern "thiscall" fn(*const c_void, *const i32, *const i32) -> u32> = FunctionDef{address: 0x004fa670, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("ztundobuffer/ztundo_buffer"))]
    pub const ZTUNDO_BUFFER: FunctionDef<unsafe extern "thiscall" fn(*const c_void) -> *const u32> = FunctionDef{address: 0x00502713, function_type: PhantomData};
}
...
pub mod ztunit {
    ...
    pub const VALIDATE_POSITION: FunctionDef<unsafe extern "thiscall" fn(*const u32, i8)> = FunctionDef{address: 0x004102b3, function_type: PhantomData};
    ...
    pub const GET_IDLE_ANIM: FunctionDef<unsafe extern "thiscall" fn(*const u32, i8) -> i32> = FunctionDef{address: 0x0041338a, function_type: PhantomData};
    ...
    pub const LOAD: FunctionDef<unsafe extern "thiscall" fn(*const u32, *const u8, u32) -> u32> = FunctionDef{address: 0x00454488, function_type: PhantomData};
    ...
    pub const AVOID_DONE: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> u32> = FunctionDef{address: 0x004a5508, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("ztunit/get_path_to_target"))]
    pub const GET_PATH_TO_TARGET: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> u32> = FunctionDef{address: 0x004a5b4d, function_type: PhantomData};
    ...
    pub const ZTUNIT: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> *const u32> = FunctionDef{address: 0x004f9cf0, function_type: PhantomData};
    ...
    pub const INIT_AFTER_LOAD: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> u32> = FunctionDef{address: 0x005951b3, function_type: PhantomData};
...
pub mod ztunittype {
    ...
    pub const LOAD_CHARACTERISTICS_0: FunctionDef<unsafe extern "thiscall" fn(*const u32, *const i32) -> u32> = FunctionDef{address: 0x004b5681, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("ztunittype/load_characteristics_1"))]
    pub const LOAD_CHARACTERISTICS_1: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> u32> = FunctionDef{address: 0x004b5c71, function_type: PhantomData};
    ...
    pub const ZTUNIT_TYPE: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> *const u32> = FunctionDef{address: 0x00500a69, function_type: PhantomData};
...
pub mod ztworldmgr {
    ...
    pub const ZTWORLD_MGR: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> *const u32> = FunctionDef{address: 0x0057cce9, function_type: PhantomData};
...
pub mod std_basic_string {
    ...
    pub const BASIC_STRING_1: FunctionDef<unsafe extern "thiscall" fn(*const c_void, *const u8, i32)> = FunctionDef{address: 0x00401da8, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("std_basic_string/basic_string_2"))]
    pub const BASIC_STRING_2: FunctionDef<unsafe extern "thiscall" fn(*const c_void, u32, *const u32) -> *const i32> = FunctionDef{address: 0x00404cf4, function_type: PhantomData};
}
...
pub mod standalone {
    ...
    #[cfg_attr(feature = "detour-validation", validate_detour("standalone/is_snap_to_ground"))]
    pub const IS_SNAP_TO_GROUND: FunctionDef<unsafe extern "thiscall" fn(*const c_void) -> u32> = FunctionDef{address: 0x00410309, function_type: PhantomData};
    ...
    #[cfg_attr(feature = "detour-validation", validate_detour("standalone/showpanel_update_available_trick_list"))]
    pub const SHOWPANEL_UPDATE_AVAILABLE_TRICK_LIST: FunctionDef<unsafe extern "cdecl" fn(*const i32)> = FunctionDef{address: 0x004522ae, function_type: PhantomData};
    ...
    pub const GENERAL_SET_SELECTED_ENTITY: FunctionDef<unsafe extern "cdecl" fn(*const u32, i8)> = FunctionDef{address: 0x004ef75b, function_type: PhantomData};
    ...
    #[cfg_attr(feature = "detour-validation", validate_detour("standalone/zooitems_add_callbacks"))]
    pub const ZOOITEMS_ADD_CALLBACKS: FunctionDef<unsafe extern "stdcall" fn()> = FunctionDef{address: 0x00516c45, function_type: PhantomData};
    ...
    pub const FORCE_UPDATE: FunctionDef<unsafe extern "thiscall" fn(*const c_void)> = FunctionDef{address: 0x0058c78e, function_type: PhantomData};
    ...
    pub const SET_BUILDING_UPGRADE: FunctionDef<unsafe extern "cdecl" fn(i32, i32, *const i8, i32, i32, i32, i8) -> u32> = FunctionDef{address: 0x0058feb7, function_type: PhantomData};
    ...
    pub const ANIMALINFO_SET_ANIMAL_DYING: FunctionDef<unsafe extern "cdecl" fn(*const u32, i8)> = FunctionDef{address: 0x005a55f6, function_type: PhantomData};
    ...
    #[cfg_attr(feature = "detour-validation", validate_detour("standalone/get_depth"))]
    pub const GET_DEPTH: FunctionDef<unsafe extern "thiscall" fn(*const c_void, *const u32) -> i32> = FunctionDef{address: 0x005af19b, function_type: PhantomData};
