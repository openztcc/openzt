...
pub mod bfapp {
    ...
    pub const LOAD_STRING: FunctionDef<unsafe extern "thiscall" fn(u32, u32, u32) -> i32> = FunctionDef{address: 0x00404e0a, function_type: PhantomData};
...
pub mod bfcoggoal {
    ...
    pub const SET_TILE: FunctionDef<unsafe extern "thiscall" fn(u32, i32)> = FunctionDef{address: 0x0041300b, function_type: PhantomData};
...
pub mod bfentity {
    ...
    pub const GET_FOOTPRINT: FunctionDef<unsafe extern "thiscall" fn(u32, u32)> = FunctionDef{address: 0x0040f916, function_type: PhantomData};
    ...
    pub const IS_WALKABLE_BY: FunctionDef<unsafe extern "thiscall" fn(u32)> = FunctionDef{address: 0x004147fd, function_type: PhantomData};
...
pub mod bfgoal {
    ...
    pub const SET_GOAL_TILE: FunctionDef<unsafe extern "thiscall" fn(u32)> = FunctionDef{address: 0x0042224d, function_type: PhantomData};
...
pub mod bfmap {
    ...
    pub const GET_NEIGHBOR_0: FunctionDef<unsafe extern "thiscall" fn(u32, u32, u32) -> i32> = FunctionDef{address: 0x0040fa92, function_type: PhantomData};
    ...
    pub const GET_NEIGHBOR_1: FunctionDef<unsafe extern "thiscall" fn(u32, u32, u32) -> i32> = FunctionDef{address: 0x00432236, function_type: PhantomData};
...
pub mod bfregistry {
    ...
    pub const PTR_GET: FunctionDef<unsafe extern "thiscall" fn(u32, u32) -> u32> = FunctionDef{address: 0x004bdd22, function_type: PhantomData};
...
// BFUIMgr::UIControl class functions
pub mod bfuimgr_uicontrol {
    use super::*;
...
// UIRadioSet::UIButton class functions
pub mod uiradioset_uibutton {
    use super::*;
...
pub mod ztanimal {
    ...
    pub const GET_FOOTPRINT: FunctionDef<unsafe extern "thiscall" fn(u32)> = FunctionDef{address: 0x00410803, function_type: PhantomData};
    ...
    pub const IS_WALKABLE_BY: FunctionDef<unsafe extern "thiscall" fn(u32)> = FunctionDef{address: 0x00431696, function_type: PhantomData};
...
pub mod ztmapview {
    ...
    pub const CHECK_TANK_PLACEMENT: FunctionDef<unsafe extern "stdcall" fn(u32, u32, u32, u32) -> bool> = FunctionDef{address: 0x004df688, function_type: PhantomData};
...
pub mod ztworldmgr {
    ...
    pub const ADD_TO_GAWK_SCENERY_LIST: FunctionDef<unsafe extern "stdcall" fn(i32) -> u32> = FunctionDef{address: 0x00451785, function_type: PhantomData};
